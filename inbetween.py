...
class Engine:
    ...
    def player_turn(self, index):
        ...
        while True:
            bet = input(f"How much would you like to bet? Input skip if you want to skip.")
            if isinstance(bet, int):
                double_confirm = input(f"Are you sure you want to bet this amount : {bet}. y for yes n for no")
                if double_confirm == "y":
                    self.table.players[index].draw_card()
                    print(self.table.player[index].hand)
